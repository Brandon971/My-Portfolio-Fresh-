  ...
  method="POST">
          <div class="app-form">
            <div class="app-form-group">
              <input class="app-form-control" required="required" data-error="name is required" placeholder="NAME">
            </div>
            <div class="app-form-group">
              <input class="app-form-control" required="required" data-error="email is required" type="email" placeholder="EMAIL">
            </div>
            <div class="app-form-group">
              <input class="app-form-control" required="required" data-error="contact number is required" placeholder="CONTACT NO">
            </div>
